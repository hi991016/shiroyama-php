...
?>
    ...
    <main class="admissionpage">
        ...
        <section class="c-thumbnail">
            <picture>
                <source media="(max-width: 1023px)" data-srcset="<?= get_template_directory_uri() ?>/assets/images/admission/admission_tour_thumb_sp.webp">
                <img class="lazy" draggable="false" data-src="<?= get_template_directory_uri() ?>/assets/images/admission/admission_tour_thumb.webp"
                    alt="入園のご案内" width="1300" height="550">
            </picture>
            <div class="c-thumbnail_heading">
                <h2>園見学について</h2>
                <p>KINDERGARTEN TOUR</p>
            </div>
        </section>
        <!-- //thumbnail -->
        ...
        <section class="admission" data-offset-top>
            <div class="admission_container">
                ...
                <div class="admission_list">
                    ...
                    <div class="admission_items" id="event" data-fadein>
                        <div class="c-feature">
                            <div class="c-feature_inner">
                                <div class="c-feature_left">
                                    <div class="is-pad-sp">
                                    ...
                                    <div class="is-pad-sp">
                                        ...
                                        <a href="<?= home_url(); ?>/news/event" class="c-btn">
                                            <p>開催日程はこちら</p>
                                            <svg class="arrow" xmlns="http://www.w3.org/2000/svg" width="27.414"
                                                height="12.828" viewBox="0 0 27.414 12.828">
                                                <g id="Group_61" data-name="Group 61"
