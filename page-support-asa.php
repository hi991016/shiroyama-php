<?php 
    /*
    Template Name: Support -After School Activities-
    */
...
?>
    ...
    <main class="supportpage">
        ...
        <section class="support" data-offset-top>
            <div class="support_container u-wrapper">
                <div class="support_intro c-introduce">
                    <h2 data-fadein>
                        コピーが入ります <br />
                        コピーが入ります
                    </h2>
                ...
                <div class="support_school">
                    <div class="support_school_items" data-fadein>
                        ...
                        <h3>パズル教室</h3>
                        <p>
                            テキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入ります（80字程度）
                        </p>
                    </div>
                    <div class="support_school_items" data-fadein>
                        <figure>
